        ...
        <Col sm={6}>
          ...
          <Col sm={6} className="text-center text-sm-end">
            ...
            <p style={{ fontSize: "larger" }}>
              Created By: <a style={{ color: '#d4af37' }} href="https://qujuan.net/">Qujuan Miller</a>/
              <a style={{ color: '#d4af37' }} href="https://www.facebook.com/gaming/TismStudioGames">TismStudios</a> 2024
            </p>
          </Col>
        </Col>
        <Col>
          ...
          <p style={{ fontSize: "larger" }}>
            Phone: <a style={{ color: '#32527b' }} href="tel:+12299771509">(229)977-1509</a>
          </p>
          <p style={{ fontSize: "larger" }}>
            Email:{" "}
            <a style={{ color: '#32527b' }}
              href="mailto:
